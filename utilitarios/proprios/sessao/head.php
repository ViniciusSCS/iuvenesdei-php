            ...
            <div class="container">
                <nav class="navbar navbar-inverse" role="navigation">
                    <div class="navbar-header">
                        ...
                        <img class="img-responsive" src="images/icone/icone.png" alt="" />
                    </div>
                    <!--/.navbar-header-->
                    <div id="main-nav" class="collapse navbar-collapse">
                        <ul class="nav navbar-nav" id="mainNav">
                            <li class="active" id="firstLink"><a href="#home" class="scroll-link" id="menu">Início</a></li>
                            <li><a href="#eventos" class="scroll-link" id="menu">Eventos</a></li>
