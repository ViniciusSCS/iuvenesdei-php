                ...
                <form method="post" action="action/emailSMTP.php" name="validate" id="contactfrm" role="form">
                    <div class="col-md-9">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nome" id="nome" placeholder="Nome" style="font-size: 15px;" title="Por favor insira seu nome" >
                            <p class="texto-email">*OBS: Nome n&atilde;o obrigat&oacute;rio</p>
                        </div>
                        <div class="form-group">
                            <label for="email" id="titulo" style="font-size:25px;">E-mail</label>
                            <input type="email" class="form-control" name="email" id="email" placeholder="E-mail" style="font-size: 15px;" title="Por favor insira um endereço de e-mail válido">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="msg" class="form-control" id="msg" cols="3" style="font-size: 15px;" placeholder="Deixe sua ora&ccedil;&atilde;o..." title="Por favor, digite a sua mensagem (pelo menos 10 caracteres )" required></textarea>
